...
//------------------------------------------------------------------------------
typedef commonDicc<size_t, ServerObject*> objectsMap;
...
class ServerMap {
 ...
 private :
    ...
    objectsMap objects;
    commonDicc<size_t, ServerBuildings*> buildings;
    commonDicc<size_t, ServerBridges*> bridges;
    commonDicc<size_t, ServerSolids*> solids;
    commonDicc<size_t, ServerFlag*> flags;
    commonDicc<size_t, ServerTerritories*> territories;
    size_t objectsQuant;
