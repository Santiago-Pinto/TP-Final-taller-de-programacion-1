...
#define LASER "laser"
//------------------------------------------------------------------------------
typedef commonDicc<const ServerNode*, const ServerNode*> diccReturn;
typedef commonDicc<const ServerNode*, double> diccCost;
typedef std::tuple<double, const ServerNode*> Pair;
typedef commonHeap<Pair> HeapNeighbors;
...
class ServerUnit {
 ...
 public :
    ...
    //--------------------------------------------------------------------------
    commonHeap<ServerTask*>& getTasks();
    //--------------------------------------------------------------------------
