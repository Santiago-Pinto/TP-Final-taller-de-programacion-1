...
//------------------------------------------------------------------------------
typedef commonDicc<size_t , ClientProxyUnit*> proxyUnitsMap;
typedef commonDicc<size_t , ClientProxyObject*> proxyObjectsMap;
typedef commonDicc<size_t , ClientProxyMunition*> proxyMunitionMap;
typedef  commonDicc<size_t , ClientProxyTerritories*> proxyTerritoriesMap;
...
class ClientProxyGame {
 public :
    ...
    uint32_t height;
 private :
    commonQueue<std::string>& petitions;
