 ...
 *  - hacer que commonQueue sea movible (implementar el constructor y el operador
 *    asignacion por movimiento)
 *  - implementar una especializacion total commonQueue<void*> y luego
 *    una especializacion parcial commonQueue<T*> con el fin de evitar el code
