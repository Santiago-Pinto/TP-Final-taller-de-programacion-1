...
// MOVE X
//------------------------------------------------------------------------------
void ClientHighCaliberAmmo::move_x(unsigned int dest_x) {
...
// MOVE Y
//------------------------------------------------------------------------------
void ClientHighCaliberAmmo::move_y(unsigned int dest_y) {
...
// MOVE XY
//------------------------------------------------------------------------------
void ClientHighCaliberAmmo::move_xy(unsigned int dest_x, unsigned int dest_y) {
